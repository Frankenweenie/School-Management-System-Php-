...
<div id="main">
    ...
    <div id="event_content">
        <div id="tab1">
            <form action="report_homework.php" method="post">
                <div id="examName" class="input">
                    ...
                    $sqle = "SELECT DISTINCT MONTHNAME(date) FROM `score_homework` where teacher_id = '$tid';";
                    $query = mysqli_query($conn, $sqle);

                    echo '<select id = "monthCombo" name="combo" >';
                    echo '<option id = disCombo2 disabled selected>Select month</option>';
                    ...
                    $sqle = "SELECT DISTINCT classname FROM `homeworkview` where teacher_id = '$tid';";
                ...
                <tr>
                    ...
                    if(isset($_POST['submitted'])){
                        ...
                        if($chosenClass!="Students of all classes"){
                            ...
                            $sql = "select distinct firstname, code from dada where teacher_id = '$tid' and teacherclass_id = '".$rowcId2['teacherclass_id']."';";
                        }else{
                            $sql = "select distinct firstname, code from dada where teacher_id = '$tid';";
                        }
                        ...
                        while($row=mysqli_fetch_array($result,MYSQL_ASSOC)){
                            $querySumScore = "select avg(score) from dada where firstname = '".$row['firstname']."' and MONTHNAME(date) = '$chosenMonth'";
                            $resultSumScore = mysqli_query($conn, $querySumScore);
                            $rowSumScore = mysqli_fetch_array($resultSumScore, MYSQL_ASSOC);
                            $percentage = $rowSumScore['avg(score)'];
                            ...
                            echo '
									<tr>
										...
										<td class="col4"><input type="text" name="tf" readonly = "readonly" value = "'.$rowSumScore['avg(score)'].'"/></td>
